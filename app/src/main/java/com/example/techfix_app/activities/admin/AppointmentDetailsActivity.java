...
public class AppointmentDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appointmentId =
                getIntent().getStringExtra("appointmentId");
    ...
    private void initializeViews() {
        ...
        tvAppointmentId =
                findViewById(R.id.tvAppointment);
        ...
        tvBranchId =
                findViewById(R.id.tvBranchId);

        tvDevice =
                findViewById(R.id.tvDevice);

        tvCategory =
                findViewById(R.id.tvCategory);

        tvProblem =
                findViewById(R.id.tvProblem);
        ...
        tvTechnician =
                findViewById(R.id.tvTechnician);

        spinnerTechnician =
                findViewById(R.id.spinnerTechnician);

        btnAssignTechnician =
                findViewById(R.id.btnAssignTechnician);

        btnCreateRepair=
                findViewById(R.id.btnCreateRepair);
    ...
    private void displayAppointment() {
        ...
        tvAppointmentId.setText(
                "Appointment For: "
                        + safe(appointment.getCustomerName())
        );
        ...
        tvServiceId.setText(
                "Service ID: "
                        + safe(appointment.getServiceId())
        );

        tvBranchId.setText(
                "Branch : "
                        + safe(appointment.getBranchId())
        );

        tvDevice.setText(
                "Device: "
                        + safe(appointment.getDeviceName())
        );

        tvCategory.setText(
                "Device Category: "
                        + safe(appointment.getDeviceCategory())
        );

        tvProblem.setText(
                "Problem: "
                        + safe(appointment.getDeviceDescription())
        );

        tvDate.setText(
                "Preferred Date: "
                        + safe(appointment.getAppointmentDate())
        );
    ...
    private void assignTechnician() {
        ...
        firestoreManager.updateAppointment(appointmentId, updates
            ...
            // Update UI directly with selected technician name
