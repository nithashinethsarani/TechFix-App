...
public class RepairHistoryAdapter
        extends RecyclerView.Adapter<RepairHistoryAdapter.ViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(RepairHistory item);
    }

    public RepairHistoryAdapter(
            List<RepairHistory> repairHistoryList,
    ...
    public void onBindViewHolder(
        ...
        holder.textDeviceName.setText(
                item.getDeviceName() != null
                        ? item.getDeviceName()
                        : "Unknown Device"
        );

        holder.textServiceName.setText(
        ...
        holder.textCompletedDate.setText(
        ...
        // Click the repair history item to open RepairStatusActivity
    ...
    public int getItemCount() {
        return repairHistoryList != null
                ? repairHistoryList.size()
                : 0;
    }
    ...
    public static class ViewHolder
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            textDeviceName =
                    itemView.findViewById(R.id.textDeviceName);

            textServiceName =
                    itemView.findViewById(R.id.textServiceName);

            textPrice =
                    itemView.findViewById(R.id.textPrice);

            textCompletedDate =
                    itemView.findViewById(R.id.textCompletedDate);
